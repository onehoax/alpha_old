<template>
  <div
    class="flex justify-center items-center h-8 sm:h-10 bg-gradient-to-l from-black to-red-500 rounded-lg mx-1 mb-2 shadow-xl shadow-stone-700"
  >
    <NuxtLink :href="email">
...
const email = "mailto:movimientoalpha@gmail.com";
const instagram = "https://www.instagram.com/movimientoalpha/";
</script>
